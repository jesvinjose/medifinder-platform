...
export const addInventory = async (req, res) => {
    try {
        ...
        const { branchId, brandedMedicineId, quantity, priceToRetailer, mrp } = req.body;
        ...
        const inventory = await BranchInventory.findOneAndUpdate({ branchId, brandedMedicineId }, {
            $set: {
                priceToRetailer,
                mrp,
